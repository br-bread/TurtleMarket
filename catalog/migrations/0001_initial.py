# Generated by Django 3.2.16 on 2022-11-01 20:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='Не забудьте указать роскошные и превосходные стороны', validators=[catalog.validators.AmazingValidator('превосходно', 'роскошно')], verbose_name='описание')),
